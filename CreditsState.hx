...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['DaveXC calamity Dev Team'],
			['DaveXC',		        'BambiXC',		        'Made the rest of the shit',	        'https://twitter.com/DaveXC01',  	'444444'],
			['FinGonz',		        'fingonz',		        'Bugfixes, excellent work',	            'https://twitter.com/FinGonz',  	'444444'],
			['Junicko',		        'junicko',		        'Some features, excellent work',	    'https://web.roblox.com/users/644653191/profile',  	'444444'],
			['Psych Engine Team'],
