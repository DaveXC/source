...
{
	public static var psychEngineVersion:String = '0.5.2h'; //This is also used for Discord RPC // i love among us 😍
	...
	override function create()
	{
		...
		var logo:FlxSprite = new FlxSprite(900, 180).loadGraphic(Paths.image('KadeEngineLogo'));
		logo.scale.y = 0.3;
		logo.scale.x = 0.3;
		...
		// Definitely didn't stole it from kade
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "DaveXC Calamity 1.0", 12);
